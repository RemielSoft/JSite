<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VisaQuery.aspx.cs" MasterPageFile="~/Site.Master" Inherits="JSVisaTrackingWebApplication.VisaQuery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <section>
        <div class="container-fulid page-heading">
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12">Visa Query</div>
                </div>
            </div>
        </div>
    </section>
