...
namespace JSVisaTrackingWebApplication
{
    public partial class Test1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Request.QueryString["REQ_ID"] != null)
                {
                    ...
                    List<VisaRequirement> lst = visaReqBal.editgrid(id);
        ...
        protected void BtnShow_Click(object sender, EventArgs e)
        {
            ...
            lst = visaReqBal.show_visainfo(ddlCountry.SelectedItem.Text, ddlVisaType.SelectedItem.Text, ddlconsulate.SelectedItem.Text);
            if (lst.Count > 0)
            {
                showTable.Visible = true;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            visaReqBal.insert(visaRequirement);
        ...
        protected void Btnupdate_Click(object sender, EventArgs e)
        {
            if (Request.QueryString["REQ_ID"] != null)
            {
                ...
                visaRequirement.NormalCollection = txtNormlcl.Text;
                visaRequirement.MyApplication = txtmyapp.Text;
                visaReqBal.update_visainfo(visaRequirement, id);
