<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true"
    CodeBehind="AddVisaRequirement.aspx.cs" Inherits="JSVisaTrackingWebApplication.Test1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="border">
        <tr>
            <td colspan="4" class="right">
                <asp:LinkButton ID="LinkButton1" PostBackUrl="~/ViewVisaRequirement.aspx" runat="server"><span class="label info">View Visa Info <i class="icon-search fg-color-white"></i></span></asp:LinkButton>
            </td>
        </tr>
        <tr>
            <td class="left">
    ...
    <div align="right"><asp:Button ID="BtnShow" CssClass="label success" runat="server" Text="Show Details" OnClick="BtnShow_Click" /></div>
    <table class="bordered" id="showTable" runat="server" visible="false">
        <tr>
            <td colspan="4">
             <blockquote>
                    <p>(please seperate each line in consulate address with &)</p>
                </blockquote>
