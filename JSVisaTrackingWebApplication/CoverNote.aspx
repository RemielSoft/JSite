<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="CoverNote.aspx.cs" Inherits="JSVisaTrackingWebApplication.CoverNote" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container-fulid page-heading">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">Add Cover Note Visa Form</div>
                <div class="col-xs-12 col-sm-6 caption text-right">Visa / Jetsave Cover Note Visa Form</div>
            </div>
        </div>
    </div>
    <div class="container">
        ...
        <div class="table-responsive">
                <asp:GridView runat="server" ID="CoverNote_gridview" AutoGenerateColumns="False" OnRowCommand="CoverNote_gridview_RowCommand"
