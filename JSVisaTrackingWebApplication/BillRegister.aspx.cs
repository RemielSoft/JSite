...
namespace JSVisaTrackingWebApplication
{
    public partial class BillRegister : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["fromdate"] != null && Session["todate"] != null && Session["ddlAgent"] != null)
            {
                txt_fromDate.Text = Convert.ToString(Session["fromdate"]);
                txt_toDate.Text = Convert.ToString(Session["todate"]);
                //ddlAgentName.SelectedItem.Text = Convert.ToString(Session["ddlAgent"]);
            }
            ...
            if (!IsPostBack)
            {
                ...
                {
                    basePage.BindDropDown(ddlAgentName, "AgentName", "AgentId", summaryBusinessAccess.Agentbind(null, basePage.LoggedInUser.AgentId));
        ...
        public void BindGrid()
        {
            if (Request.QueryString["List"] != null)
            {
                ...
                if (userId == Convert.ToInt32(UserType.Admin))
                {
                    ...
                    gv_billRegister.EnableViewState = false;
                }
                else
                {
                    gridviewBillRegisterList.DataSource = lst;
                    gridviewBillRegisterList.DataBind();
                    btnExport.Visible = false;
        ...
        protected void gv_billRegister_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Double otherCh = Convert.ToDouble(lbl_OtherCharges.Text);
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            if (userId == Convert.ToInt32(UserType.Admin))
            {
                ...
                gv_billRegister.FooterRow.HorizontalAlign = HorizontalAlign.Right;
                gv_billRegister.RenderControl(htm);
            }
            else
            {
                gridviewBillRegisterList.AllowPaging = false;
                gridviewBillRegisterList.FooterRow.HorizontalAlign = HorizontalAlign.Right;
                gridviewBillRegisterList.RenderControl(htm);
            }
        ...
        protected void gridviewInvoiceList_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            ...
            gridviewBillRegisterList.PageIndex = e.NewPageIndex;
            BindGrid();
        }
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            ...
            Session["ddlAgent"] = ddlAgentName.SelectedItem.Text;
            lblbri.Text = "Bill Summary Information";
            btnExport.Visible = true;
                ...
                if (txt_fromDate.Text != "" && txt_toDate.Text != "")
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if (totalDays <= 90)
                            {
                                lst = billRegisterBal.BillRegisterByDate(fromdate, todate, AgentId, LocId);
                            }
                            else
                            {
            ...
            {
                if (txt_fromBill.Text != "" && txt_toBill.Text != "")
                {
                    ...
                    else
                    {
                        ...
                        {
                            lst = billRegisterBal.ReadBillRegisterBYFromBillNo(frombill, tobill, AgentId, LocId);
                            btnExport.Visible = false;
                        }
                ...
                else if (ddlAgentName.SelectedValue != null)
                {
                    ...
                    {
                        lst = billRegisterBal.BillRegisterByAgentName(fromdate, todate, AgentId, LocId);
                    }
                    Session["List"] = lst;
                    if (lst.Count == 0)
                    {
        ...
        protected void gv_billRegister_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            gv_billRegister.PageIndex = e.NewPageIndex;
            BindGrid();
        }
